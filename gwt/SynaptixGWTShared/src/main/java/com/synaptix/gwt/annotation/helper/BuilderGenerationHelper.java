 ...
 * 
 * Rules: No optional fields - no Builder. Has required fields and optional
 * fields - Constructor for required fields + Builder. Has optional fields -
 * only Builder.
 * 
...
public class BuilderGenerationHelper extends ClassGenerationHelper {
	...
	/**
	 * Creates a private object constructor which should only ever be called by
	 * the intern Builder class.
	 * 
	...
	/**
	 * Helper method to create the Builder#build() method which returns a
