...
public class RepositorySetup {
	 ...
	 * 
	 * @param entityName
	 *            Test name of entity class containing the property.
	 * @param propertyName
	 *            Test name of entity property.
	 * @param propertyValue
	 *            Value to select.
	 * @return
	 */
	public IComponent selectEntity(String entityName, String propertyName, String propertyValue) {
