...
//import com.mongo.test.domain.def.test.InsertBlock;
...
//	public String generatePageHtml(TestPage testPage) {
//		StringBuilder report = new StringBuilder();
//		report.append("<meta http-equiv=\"content-type\" content=\"text/html; charset=utf-8\" />");
//		report.append("<LINK href=\"style.css\" rel=\"stylesheet\" type=\"text/css\">");
...
//			report.append("</td>");
//			report.append("<td>");
//			report.append(line.getTestResult() != null ? line.getTestResult().getMessage() : "&nbsp");
//			report.append("</td>");
//			report.append("<td>");
...
//	 */
//	public void writeFile(String report, TestPage page) {
//		try {
//			FileWriter fstream = new FileWriter(page.getFile().getParentFile().getCanonicalPath() + "\\out\\" + page.getPageName().substring(0, page.getPageName().length() - 4) + "_out.html");
//			System.out.println("Writing result to " + page.getFile().getParentFile().getCanonicalPath() + "\\out\\");
...
//	}
//
//	public void writeFile(String report, String path) {
//		try {
