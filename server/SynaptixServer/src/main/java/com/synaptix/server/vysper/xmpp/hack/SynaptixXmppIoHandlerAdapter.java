...
public class SynaptixXmppIoHandlerAdapter implements IoHandler {
	...
	public static final String ATTRIBUTE_IO_SESSION = "ioSession";
	...
	public void sessionCreated(IoSession ioSession) throws Exception {
		...
		sessionContext.putAttribute(ATTRIBUTE_IO_SESSION, ioSession);
	}
