...
public class Zlib {
	 ...
	 *            the level of compression that should be used. One of <tt>COMPRESSION_MAX</tt>, <tt>COMPRESSION_MIN</tt>, <tt>COMPRESSION_NONE</tt> or <tt>COMPRESSION_DEFAULT</tt>
	 * @param mode
	 *            the mode in which the instance will operate. Can be either of <tt>MODE_DEFLATER</tt> or <tt>MODE_INFLATER</tt>
	 ...
	 * 
	 * @param inBuffer
	 *            the {@link IoBuffer} to be decompressed. The contents of the buffer are transferred into a local byte array and the buffer is flipped and returned intact.
	 ...
	 * 
	 * @param inBuffer
	 *            the buffer to be compressed. The contents are transferred into a local byte array and the buffer is flipped and returned intact.
