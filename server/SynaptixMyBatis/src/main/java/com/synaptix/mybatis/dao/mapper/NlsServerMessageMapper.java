...
public interface NlsServerMessageMapper {
	...
	public int mergeNlsServerMessage(@Param("tableName") String tableName, @Param("idObject") Serializable idObject, @Param("language") String language, @Param("columnName") String columnName,
	...
	public int deleteNlsServerMessages(@Param("tableName") String tableName, @Param("idObject") Serializable idObject);
}
