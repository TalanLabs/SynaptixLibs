 ...
 */
public class DefaultSelectionModel extends AbstractSelectionModel implements
		Serializable {

	private static final long serialVersionUID = -96368065639890249L;
	...
	public boolean isSelected(int row, int column) {
		return ((row >= firstSelectedRow && row <= lastSelectedRow) && (column >= firstSelectedColumn && column <= lastSelectedColumn));
	}
