...
public class DefaultRoulementTimelineDayDatesHeaderRenderer implements
		RoulementTimelineDayDatesHeaderRenderer {
	...
	public DefaultRoulementTimelineDayDatesHeaderRenderer() {
		this(Position.Left);
	}

	public DefaultRoulementTimelineDayDatesHeaderRenderer(Position position) {
	...
	public void paintHeader(Graphics2D g,
		...
		if (header.getRoulementTimeline() != null
				&& header.getRoulementTimeline().isDynamicDayDatesHeader()) {
