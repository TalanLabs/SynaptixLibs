...
public class DefaultSimpleTimelineResourceRenderer extends JComponent implements
		SimpleTimelineResourceRenderer {
	...
	public DefaultSimpleTimelineResourceRenderer() {
		super();
		this.setOpaque(true);
	}
