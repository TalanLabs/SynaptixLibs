...
import com.synaptix.swing.plaf.RoulementTimelineLeftResourceHeaderUI;
...
public class BasicRoulementTimelineLeftResourceHeaderUI extends
		RoulementTimelineLeftResourceHeaderUI {

	private static Cursor resizeCursor = Cursor
			.getPredefinedCursor(Cursor.N_RESIZE_CURSOR);

	protected JRoulementTimelineLeftResourcesHeader header;
	...
	public static ComponentUI createUI(JComponent h) {
		return new BasicRoulementTimelineLeftResourceHeaderUI();
	}

	public void installUI(JComponent c) {
		header = (JRoulementTimelineLeftResourcesHeader) c;
	...
	private static boolean canResize(RoulementTimelineResource resource,
			JRoulementTimelineLeftResourcesHeader header) {
	...
	private int changeResourceHeight(
			...
			JRoulementTimelineLeftResourcesHeader th, int oldHeight, int newHeight) {
	...
	private Component getHeaderRenderer(int resourceIndex, boolean isDrag) {
		...
		boolean hasFocus = !header.isPaintingForPrint()
				...
				&& header.hasFocus();
		return renderer.getRoulementTimelineLeftResourceRendererComponent(
