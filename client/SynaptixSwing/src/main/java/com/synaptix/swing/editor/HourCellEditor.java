...
public class HourCellEditor extends AbstractCellEditor implements
	...
	public HourCellEditor(boolean defaultNull) {
		super();

		editorComponent = SwingComponentFactory.createHourField(defaultNull);
