...
public final class IconFeedbackPanel extends AbstractIconFeedbackValidationResultPanel {
	...
	protected ValidationResult getAssociatedResult(JComponent comp,
		...
		ValidationResult result = ValidationComponentUtils.getAssociatedResult(
				comp, keyMap);
