...
public class RoulementTimelineResource {
	...
	protected RoulementTimelineResourceRenderer headerRenderer;
	...
	public RoulementTimelineResource() {
		this(0);
	}

	public RoulementTimelineResource(int modelIndex) {
		this(modelIndex, DEFAULT_HEIGHT);
	}

	public RoulementTimelineResource(int modelIndex, int height) {
		super();
	...
	public void setHeaderRenderer(
			RoulementTimelineResourceRenderer headerRenderer) {
		RoulementTimelineResourceRenderer old = this.headerRenderer;
		this.headerRenderer = headerRenderer;
		firePropertyChange("headerRenderer", old, headerRenderer); //$NON-NLS-1$
	}

	public RoulementTimelineResourceRenderer getHeaderRenderer() {
	...
	public void sizeWidthToFit() {
		...
		Component c = headerRenderer
				.getRoulementTimelineLeftResourceRendererComponent(null, this, 0,
						false, false, false);
