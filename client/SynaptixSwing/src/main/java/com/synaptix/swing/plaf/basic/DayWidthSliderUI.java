...
public class DayWidthSliderUI extends SliderUI {
	...
	static {
		Image image = null;
		try {
			image = ImageIO.read(DayWidthSliderUI.class
					.getResource("/images/zoomSlider.png")); //$NON-NLS-1$
		} catch (IOException e) {
			e.printStackTrace();
		}
		...
		try {
			image = ImageIO.read(DayWidthSliderUI.class
					.getResource("/images/zoomBarSlider.png")); //$NON-NLS-1$
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	public static ComponentUI createUI(JComponent b) {
		return new DayWidthSliderUI((JSlider) b);
	}

	public DayWidthSliderUI() {
	}

	private DayWidthSliderUI(JSlider b) {
	}
	...
	protected void installKeyboardActions(JSlider slider) {
		...
		LazyActionMap.installLazyActionMap(slider, DayWidthSliderUI.class,
	...
	public class ActionScroller extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			SHARED_ACTION.scroll(slider, DayWidthSliderUI.this, dir, block);
		}
