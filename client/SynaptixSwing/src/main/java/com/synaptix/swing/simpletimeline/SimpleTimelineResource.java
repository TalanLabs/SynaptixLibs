...
public class SimpleTimelineResource {
	...
	protected SimpleTimelineResourceRenderer headerRenderer;
	...
	public SimpleTimelineResource() {
		this(0);
	}

	public SimpleTimelineResource(int modelIndex) {
		this(modelIndex, DEFAULT_HEIGHT);
	}

	public SimpleTimelineResource(int modelIndex, int height) {
		super();
	...
	public void setHeaderRenderer(SimpleTimelineResourceRenderer headerRenderer) {
		SimpleTimelineResourceRenderer old = this.headerRenderer;
		this.headerRenderer = headerRenderer;
		firePropertyChange("headerRenderer", old, headerRenderer); //$NON-NLS-1$
	}

	public SimpleTimelineResourceRenderer getHeaderRenderer() {
	...
	public void sizeWidthToFit() {
		...
		Component c = headerRenderer
				.getSimpleTimelineResourceRendererComponent(null, this, 0,
						false, false, false);
