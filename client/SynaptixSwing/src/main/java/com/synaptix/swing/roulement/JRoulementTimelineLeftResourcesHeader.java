...
public class JRoulementTimelineLeftResourcesHeader extends JComponent implements
		RoulementTimelineResourcesModelListener {

	private static final long serialVersionUID = 2253293907751629570L;

	private static final String uiClassID = "RoulementTimelineLeftRessourceHeaderUI"; //$NON-NLS-1$
	...
	static {
		UIManager
				.getDefaults()
				.put(uiClassID,
						"com.synaptix.swing.plaf.basic.BasicRoulementTimelineLeftResourceHeaderUI"); //$NON-NLS-1$
	}

	public JRoulementTimelineLeftResourcesHeader(
	...
	public RoulementTimelineLeftResourceHeaderUI getUI() {
		return (RoulementTimelineLeftResourceHeaderUI) ui;
	}

	public void setUI(RoulementTimelineLeftResourceHeaderUI ui) {
		if (this.ui != ui) {
			super.setUI(ui);
			repaint();
		}
	...
	public void updateUI() {
		setUI((RoulementTimelineLeftResourceHeaderUI) UIManager.getUI(this));
