	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				...
				simpleDaysTimeline1.setShowIntersection(true);
				simpleDaysTimeline1.setMultiLine(true);
				simpleDaysTimeline1.setAutoHeight(true);
				simpleDaysTimeline1.setAutoscrolls(true);
				simpleDaysTimeline1.setGroupFactory(new MySimpleDaysTimelineGroupFactory());
				...
				simpleDaysTimeline1.getResourcesHeader().setReorderingAllowed(true);
				...
				frame.setTitle("GroupSimpleDaysTimeline");
				frame.pack();
				...
				simpleDaysTimeline1.getSimpleDaysTimelineCenter().precalculeMultiLine();
			}
		});
	}
