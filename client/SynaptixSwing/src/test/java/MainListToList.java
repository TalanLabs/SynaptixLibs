...
public class MainListToList {

	private static class MyDocumentListener extends AbstractFilters<String> implements DocumentListener {
	...
	public static void main(String[] args) {
		...
		listToList.setAllValues(new String[] { "Yamm", "Gaby", "Toto", "Tata", "Sandra" });
		...
		FormLayout layout = new FormLayout("RIGHT:MAX(40DLU;DEFAULT):NONE,FILL:4DLU:NONE,FILL:75DLU:NONE,FILL:25DLU:GROW(1.0)", "d,4dlu,d,4dlu,p");
		...
		// JDialogModel dialog = new JDialogModel("", builder.getPanel(),
		// actions)
