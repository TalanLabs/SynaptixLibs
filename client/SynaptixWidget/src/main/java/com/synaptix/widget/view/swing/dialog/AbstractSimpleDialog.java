...
public abstract class AbstractSimpleDialog extends WaitComponentFeedbackPanel implements IValidationView {
	 ...
	 * @return
	 */
	protected int showDialog(Component parent, String title, String subTitle, boolean readOnly, boolean resizable) {
		if (readOnly) {
