...
public abstract class AbstractSendAction extends AbstractAction {
	...
	public AbstractSendAction() {
		this(StaticWidgetHelper.getSynaptixWidgetConstantsBundle().send());
	}

	public AbstractSendAction(String text) {
		super(text, IconHelper.Icons.SEND.getIcon());
	}
}
