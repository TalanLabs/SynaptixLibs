...
import com.synaptix.widget.view.swing.AbstractBeanDialog;
import com.synaptix.widget.view.swing.AbstractBeanDialog.BeanExtensionDialogCellRenderer;

public class DefaultBeanExtensionDialogCellRenderer<T> extends JBigLetters implements BeanExtensionDialogCellRenderer<T> {
	...
	public Component getCellRendererComponent(AbstractBeanDialog<T> beanDialog, IBeanExtensionDialog<T> led, boolean isSelected) {
		ValidationResult v = beanDialog.getValidationResult(led.getId());
