...
public class ValueComponentSubstanceTreeCellRenderer<E> extends SubstanceDefaultTreeCellRenderer implements Icon {
	...
	public ValueComponentSubstanceTreeCellRenderer() {
		this(null);
	}

	public ValueComponentSubstanceTreeCellRenderer(IValueComponent<E> valueComponent) {
		super();
	...
	public void paintIcon(Component c, Graphics g, int x, int y) {
		...
		cellRendererPane.paintComponent(g2, getComponent(), ValueComponentSubstanceTreeCellRenderer.this, 0, 0, getIconWidth(), getIconHeight(), true);
