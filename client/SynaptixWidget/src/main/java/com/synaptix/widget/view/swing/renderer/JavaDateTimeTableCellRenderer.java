...
public class JavaDateTimeTableCellRenderer extends TypeGenericSubstanceTableCellRenderer<Date> {

	private static final long serialVersionUID = -2171627954700057007L;

	public JavaDateTimeTableCellRenderer() {
		super(new AbstractDateGenericObjectToString() {
			@Override
			protected DateFormat getDateFormat() {
				return new SimpleDateFormat(StaticWidgetHelper.getSynaptixDateConstantsBundle().displayDateTimeFormat());
			}
		});
	}
}
