...
public class JTauxLabel extends JLabel {
	...
	public JTauxLabel(Type type) {
		...
		this.setFont(new Font("arial", Font.BOLD, 12)); //$NON-NLS-1$
	...
	public void setTaux(Number taux) {
		...
		firePropertyChange("taux", oldValue, taux); //$NON-NLS-1$
	...
	public void setShowBackground(boolean showBackground) {
		...
		firePropertyChange("showBackground", oldValue, showBackground); //$NON-NLS-1$
