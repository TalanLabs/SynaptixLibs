...
public class LocalDateTextFieldDecorator extends JLayeredPane {
	...
	public static JComponent decorate(JFormattedTextField formattedTextField) {
		return new LocalDateTextFieldDecorator(formattedTextField);
	}
	...
	private LocalDateTextFieldDecorator(JFormattedTextField formattedTextField) {
		super();
