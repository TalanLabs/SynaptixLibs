...
@Entity
@Table(name = "T_ZIP")
@Cache(readOnly = true, links = { IZip.class })
public interface IZipView extends IEntity {
	...
	@Collection(sqlTableName = "T_STATE", idSource = "ID_STATE", alias = "s_", componentClass = IState.class)
	public IState getStateEntity();

	public void setStateEntity(IState stateEntity);
