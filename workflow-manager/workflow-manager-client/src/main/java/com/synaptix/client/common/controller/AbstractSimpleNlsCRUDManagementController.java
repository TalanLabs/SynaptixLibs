 ...
 */
public abstract class AbstractSimpleNlsCRUDManagementController<V extends ICommonViewFactory, E extends IEntity & INlsMessage> extends AbstractCRUDManagementController<V, E, E> implements
		INlsCRUDManagementController<E> {

	private INlsMessageExtendedContext nlsMessageExtendedContext;

	public AbstractSimpleNlsCRUDManagementController(V viewFactory, Class<E> componentClass) {
		this(viewFactory, componentClass, null, null);
	}

	public AbstractSimpleNlsCRUDManagementController(V viewFactory, Class<E> componentClass, Class<? extends ICRUDEntityService<E>> crudEntityServiceClass,
