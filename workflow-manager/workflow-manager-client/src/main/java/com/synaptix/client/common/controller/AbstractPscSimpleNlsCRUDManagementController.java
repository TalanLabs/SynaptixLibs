 ...
 */
public abstract class AbstractPscSimpleNlsCRUDManagementController<V extends ICommonViewFactory, E extends IEntity & INlsMessage> extends AbstractSimpleCRUDManagementController<V, E> implements
		INlsCRUDManagementController<E> {

	private INlsMessageExtendedContext nlsMessageExtendedContext;

	public AbstractPscSimpleNlsCRUDManagementController(V viewFactory, Class<E> componentClass) {
		this(viewFactory, componentClass, null, null);
	}

	public AbstractPscSimpleNlsCRUDManagementController(V viewFactory, Class<E> componentClass, Class<? extends ICRUDEntityService<E>> crudEntityServiceClass,
