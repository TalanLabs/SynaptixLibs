...
public class GraphCalcParser extends Parser {
	public static final String[] tokenNames = new String[] { "<invalid>", "<EOR>", "<DOWN>", "<UP>", "ID", "LPAREN", "NEXT", "PARALLEL", "RPAREN", "WHITESPACE" };
	...
	public GraphCalcParser(TokenStream input, RecognizerSharedState state) {
		super(input, state);
	}

	@Override
	public String[] getTokenNames() {
		return GraphCalcParser.tokenNames;
	}

	@Override
	public String getGrammarFileName() {
		return "fr\\gefco\\tli\\psc\\common\\manager\\antlr\\GraphCalc.g";
	}
	...
	// $ANTLR start "compile"
	// fr\\gefco\\tli\\psc\\common\\manager\\antlr\\GraphCalc.g:31:1: compile returns [AbstractNode res] : a= expr EOF ;
	public final AbstractGraphNode compile() throws RecognitionException {
		...
		try {
			// fr\\gefco\\tli\\psc\\common\\manager\\antlr\\GraphCalc.g:31:35: (a= expr EOF )
			// fr\\gefco\\tli\\psc\\common\\manager\\antlr\\GraphCalc.g:31:37: a= expr EOF
			{
	...
	// $ANTLR start "expr"
	// fr\\gefco\\tli\\psc\\common\\manager\\antlr\\GraphCalc.g:33:1: expr returns [AbstractNode value] :a= term ( PARALLEL b= term )* ;
	public final AbstractGraphNode expr() throws RecognitionException {
		...
		try {
			// fr\\gefco\\tli\\psc\\common\\manager\\antlr\\GraphCalc.g:33:33: (a= term ( PARALLEL b= term )* )
			// fr\\gefco\\tli\\psc\\common\\manager\\antlr\\GraphCalc.g:33:35: a= term ( PARALLEL b= term )*
			{
				...
				nodes.add(a);
				// fr\\gefco\\tli\\psc\\common\\manager\\antlr\\GraphCalc.g:33:122: ( PARALLEL b= term )*
				loop1: while (true) {
					int alt1 = 2;
					...
					switch (alt1) {
					case 1:
					// fr\\gefco\\tli\\psc\\common\\manager\\antlr\\GraphCalc.g:33:124: PARALLEL b= term
					{
	...
	// $ANTLR start "term"
	// fr\\gefco\\tli\\psc\\common\\manager\\antlr\\GraphCalc.g:35:1: term returns [AbstractNode value] : a= factor ( NEXT b= factor )? ;
	public final AbstractGraphNode term() throws RecognitionException {
		...
		try {
			// fr\\gefco\\tli\\psc\\common\\manager\\antlr\\GraphCalc.g:35:33: (a= factor ( NEXT b= factor )? )
			// fr\\gefco\\tli\\psc\\common\\manager\\antlr\\GraphCalc.g:35:35: a= factor ( NEXT b= factor )?
			{
				pushFollow(FOLLOW_factor_in_term163);
				a = factor();
				state._fsp--;

				// fr\\gefco\\tli\\psc\\common\\manager\\antlr\\GraphCalc.g:35:44: ( NEXT b= factor )?
				int alt2 = 2;
				...
				switch (alt2) {
				case 1:
				// fr\\gefco\\tli\\psc\\common\\manager\\antlr\\GraphCalc.g:35:46: NEXT b= factor
				{
	...
	// $ANTLR start "factor"
	// fr\\gefco\\tli\\psc\\common\\manager\\antlr\\GraphCalc.g:37:1: factor returns [AbstractNode value] : ( ID | ( LPAREN a= expr RPAREN ) );
	public final AbstractGraphNode factor() throws RecognitionException {
		...
		try {
			// fr\\gefco\\tli\\psc\\common\\manager\\antlr\\GraphCalc.g:37:35: ( ID | ( LPAREN a= expr RPAREN ) )
			int alt3 = 2;
			...
			switch (alt3) {
			case 1:
			// fr\\gefco\\tli\\psc\\common\\manager\\antlr\\GraphCalc.g:37:37: ID
			{
				...
				break;
			case 2:
			// fr\\gefco\\tli\\psc\\common\\manager\\antlr\\GraphCalc.g:37:80: ( LPAREN a= expr RPAREN )
			{
				// fr\\gefco\\tli\\psc\\common\\manager\\antlr\\GraphCalc.g:37:80: ( LPAREN a= expr RPAREN )
				// fr\\gefco\\tli\\psc\\common\\manager\\antlr\\GraphCalc.g:37:82: LPAREN a= expr RPAREN
				{
